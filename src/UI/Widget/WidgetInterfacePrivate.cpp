...
WidgetInterfacePrivate::WidgetInterfacePrivate()
{
	...
	connect(aplayer, &APlayer::stateChanged, this, &WidgetInterfacePrivate::setWindowFlags);
	...
	connect(load, &Load::progressChanged, this, &WidgetInterfacePrivate::percent);
	...
	addAction(quitA);
	connect(quitA, &QAction::triggered, this, &WidgetInterfacePrivate::close);
...
void WidgetInterfacePrivate::closeEvent(QCloseEvent * e)
{
...
void WidgetInterfacePrivate::dragEnterEvent(QDragEnterEvent * e)
{
...
void WidgetInterfacePrivate::dropEvent(QDropEvent * e)
{
	if (e->mimeData()->hasFormat("text/uri-list")) {
...
void WidgetInterfacePrivate::mouseDoubleClickEvent(QMouseEvent * e)
{
...
void WidgetInterfacePrivate::mouseMoveEvent(QMouseEvent * e)
{
	QPoint cur = e->pos();
	int x = cur.x(), y = cur.y(), w = width(), h = height();
	if (isActiveWindow()) {
...
void WidgetInterfacePrivate::mousePressEvent(QMouseEvent * e)
{
...
void WidgetInterfacePrivate::mouseReleaseEvent(QMouseEvent * e)
{
...
void WidgetInterfacePrivate::resizeEvent(QResizeEvent * e)
{
...
QSize WidgetInterfacePrivate::parseSize(QString string)
{
...
void WidgetInterfacePrivate::setGeometry(QSize size, bool center)
{
	if (size.isEmpty()) {
...
void WidgetInterfacePrivate::checkForUpdate()
{
...
void WidgetInterfacePrivate::showContextMenu(QPoint p)
{
	bool flag = true;
