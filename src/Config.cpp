	...
	QDialog(parent),d_ptr(new ConfigPrivate)
{
	...
	//Playing
	{
		...
		connect(d->play[0],&QLineEdit::editingFinished,[this,d](){
		...
		connect(d->play[1],&QLineEdit::editingFinished,[this,d](){
		...
		connect(d->factor,&QLineEdit::editingFinished,[this,d](){
		...
		connect(d->bold,&QCheckBox::stateChanged,[this,d](int s){
		...
		connect<void (QComboBox::*)(int)>(d->effect,&QComboBox::currentIndexChanged,[this,d](int i){
	...
	//Interface
	{
		...
		connect(d->size,&QLineEdit::editingFinished,[this,d](){
		...
		connect(d->jump,&QLineEdit::editingFinished,[this,d](){
		...
		connect(d->stay,&QCheckBox::stateChanged,[this,d](int state){
		...
		connect(d->less,&QCheckBox::stateChanged,[this,d](int state){
		...
		connect(d->vers,&QCheckBox::stateChanged,[this,d](int state){
		...
		connect(d->sens,&QCheckBox::stateChanged,[this,d](int state){
		...
		connect(d->font,&QComboBox::currentTextChanged,[this,d](QString _font){
		...
		connect<void (QComboBox::*)(int)>(d->reop,&QComboBox::currentIndexChanged,[this,d](int i){
		...
		connect(d->skip,&QCheckBox::stateChanged,[this,d](int state){
		...
		connect(d->sing,&QCheckBox::stateChanged,[this,d](int state){
		...
		connect(d->back,&QLineEdit::textChanged,[this,d](){
	...
	//Shield
	{
		...
		connect(d->same,&QSlider::valueChanged,[this,d](int value){
		...
		connect(d->limit,&QLineEdit::editingFinished,[this,d](){
	...
	//Network
	{
		...
		connect<void (QComboBox::*)(int)>(d->arg,&QComboBox::currentIndexChanged,[this,d](int index){
			QNetworkProxy proxy=QNetworkProxy::applicationProxy();
			switch(index){
			case 0:
	...
	//Plugin
	{
		...
		connect(d->plugin,&QTreeWidget::itemChanged,[this,d](QTreeWidgetItem *item){
